  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-indigo-600/30 rounded-full blur-3xl animate-float" />
        ...
        <div className="absolute top-1/2 left-1/2 w-72 h-72 bg-fuchsia-600/20 rounded-full blur-3xl animate-float" style={{ animationDelay: "4s" }} />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-bold">EROT</span>
      ...
      <header className="relative pt-40 pb-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 mb-8 px-5 py-2.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 text-indigo-300 text-sm font-medium animate-fade-in-up">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight mb-8 animate-fade-in-up stagger-1">
            <span className="block">EROT Erken Okuryazarlık Testi</span>
            <span className="block mt-4 gradient-text">
              Uygulayıcısı Olmak İster misiniz?
            </span>
          </h1>

          <p className="text-xl sm:text-2xl text-slate-400 max-w-4xl mx-auto mb-12 leading-relaxed animate-fade-in-up stagger-2">
            ...
            <span className="text-white font-semibold">Prof. Dr. Tevhide KARGIN</span>{" "}
            ve{" "}
            <span className="text-white font-semibold">Prof. Dr. Birkan GÜLDENOĞLU</span>{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up stagger-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-shine group flex items-center gap-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white px-10 py-5 rounded-2xl font-semibold text-lg transition-all hover:shadow-2xl hover:shadow-indigo-500/30 animate-pulse-glow"
            >
            ...
            <a
              href="#hakkinda"
              className="flex items-center gap-2 text-slate-400 hover:text-white px-8 py-5 rounded-2xl font-medium transition-colors border border-slate-700 hover:border-slate-500"
            >
              Daha Fazla Bilgi
      ...
      <section id="hakkinda" className="relative py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              <p className="text-lg text-slate-300 leading-relaxed mb-8">
                ...
                <span className="text-white font-semibold">bilimsel temelli bir değerlendirme aracıdır</span>.
              ...
              <div className="relative p-8 rounded-3xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20">
                ...
                <h3 className="font-bold text-xl mb-3 text-white">Geliştirilme Amacı</h3>
            ...
            <div className="grid gap-6">
              {[
                ...
                <div
                  key={index}
                  className="hover-card group p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-indigo-500/50"
                >
          ...
          <div className="relative rounded-3xl overflow-hidden mb-20">
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-fuchsia-600 animate-gradient" />
            <div className="relative p-10 sm:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="glass rounded-3xl p-8 text-center min-w-[180px]">
                <div className="text-6xl font-bold text-slate-900 mb-1">5-6</div>
          ...
          {/* 7 Alt Boyut */}
          <div className="mb-20">
            <h3 className="text-3xl font-bold text-center mb-4">EROT Neleri Ölçer?</h3>
            <p className="text-slate-400 text-center mb-12">Okuma başarısının temel taşlarını oluşturan 7 farklı alt boyut</p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
              {[
                ...
                <div
                  key={index}
                  className="hover-card group relative p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-transparent overflow-hidden"
                >
          ...
          {/* Eğitmenler */}
          <div>
            <h3 className="text-3xl font-bold text-center mb-4">Eğitmenler</h3>
            <p className="text-slate-400 text-center mb-12">Alanında uzman akademisyenler tarafından verilen eğitim</p>

            <div className="grid md:grid-cols-2 gap-8">
              <article className="hover-card group relative p-8 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 overflow-hidden">
                ...
                <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-6">
                  <div className="relative">
                    <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 blur opacity-50 group-hover:opacity-75 transition-opacity" />
                    <Image
                      src="/egitmen_tevhide_kargin.png"
                      alt="Prof. Dr. Tevhide Kargın - EROT Eğitmeni"
                      width={100}
                      height={100}
                      className="relative w-24 h-24 rounded-full object-cover border-2 border-slate-700"
                    />
                  </div>
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-indigo-400 font-medium">Hasan Kalyoncu Üniversitesi</p>
                  </div>
                </div>
              ...
              <article className="hover-card group relative p-8 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700 overflow-hidden">
                <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-br from-purple-500/20 to-transparent rounded-full blur-2xl" />
                <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-6">
                  <div className="relative">
                    <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-purple-500 to-fuchsia-600 blur opacity-50 group-hover:opacity-75 transition-opacity" />
                    <Image
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <p className="text-purple-400 font-medium">Ankara Üniversitesi</p>
                  </div>
                </div>
                <p className="text-slate-400 leading-relaxed">
      ...
      <section id="egitim" className="relative py-32 bg-slate-900/50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 border border-slate-700">
              <h3 className="font-bold text-xl mb-6">Eğitim İçeriği</h3>
              <ul className="space-y-4">
                {[
                  ...
                  <li key={index} className="flex items-start gap-4 p-4 rounded-xl bg-slate-800/50 hover:bg-slate-800 transition-colors">
          ...
          <div className="p-10 rounded-3xl bg-slate-900 border border-slate-800">
            <h3 className="text-2xl font-bold text-center mb-4">Neden Bu Testi Uygulamalısınız?</h3>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Geleceği Öngörür", desc: "Anaokulu dönemindeki beceriler, 4. sınıftaki okuma başarısının en güçlü yordayıcısıdır.", color: "from-blue-500 to-cyan-500" },
                { title: "Etiketlemeyi Önler", desc: 'Çocuk "başarısız" olarak etiketlenmeden, hangi alanda zorlandığı tespit edilir.', color: "from-green-500 to-emerald-500" },
                { title: "Objektif Veri Sunar", desc: "Gözlemleri bilimsel ve standardize edilmiş verilerle destekler.", color: "from-violet-500 to-purple-500" },
                { title: "Disleksi Riskini Bulur", desc: "Erken tespit ile akranlarını yakalama şansını %80'e kadar artırır.", color: "from-orange-500 to-amber-500" },
              ].map((item, index) => (
                <div key={index} className="hover-card text-center p-8 rounded-2xl bg-slate-800/50 border border-slate-700">
      ...
      <section id="dernek" className="relative py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
          ...
          <div className="grid lg:grid-cols-2 gap-16 mb-20">
            <div>
              <h3 className="text-3xl font-bold mb-6">Biz Kimiz?</h3>
              <p className="text-lg text-slate-300 leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-3 gap-4 p-6 rounded-2xl bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 mb-8">
                {[
                  ...
                  <div key={i} className="text-center">
                    ...
                    <div className="text-slate-400 text-sm">{item.bottom}</div>
                  </div>
                ))}
              </div>
            ...
            <div className="space-y-6">
              <div className="p-8 rounded-3xl bg-gradient-to-br from-indigo-600 to-purple-700 relative overflow-hidden">
              ...
              <div className="p-8 rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 relative overflow-hidden">
                ...
                <div className="relative">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="font-bold text-2xl">Misyon</h4>
                  </div>
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                ...
                <div key={index} className="hover-card group p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-indigo-500/50">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 flex items-center justify-center mb-4 group-hover:from-indigo-500 group-hover:to-purple-600 transition-all">
      ...
      <section className="py-32 bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-8">EROT Uygulayıcıları</h2>
            <div className="max-w-2xl mx-auto p-12 rounded-3xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700">
              <div className="w-24 h-24 mx-auto mb-8 rounded-3xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center animate-pulse-glow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <div className="glass-dark rounded-3xl p-10 border border-white/10">
              <h3 className="text-2xl font-bold mb-8">Eğitim İçeriği</h3>
            ...
            <div className="flex items-center justify-center">
              <div className="glass rounded-3xl p-10 text-center w-full max-w-md">
                <div className="text-8xl font-bold text-slate-900 mb-2">28</div>
                <div className="text-3xl font-semibold text-slate-800 mb-2">Mart 2026</div>
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm">Erken Okuryazarlık Testi</p>
                </div>
              </div>
